...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 6244, 523))
        ...
        self.menu_3.setTitle("设计")

        self.menu_4 = QtWidgets.QMenu(self.menuBar)
        self.menu_4.setObjectName("menu_4")
        self.menu_4.setTitle("布局")
        ...
        self.menuBar.addAction(self.menu_3.menuAction())  # 将“编辑”菜单的菜单项添加到菜单栏中
        self.menuBar.addAction(self.menu_4.menuAction())  # 将“编辑”菜单的菜单项添加到菜单栏中
