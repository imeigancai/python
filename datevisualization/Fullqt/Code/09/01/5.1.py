...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(30, 30, 3014, 816))
        ...
        self.label.setPixmap(QPixmap('abc.jpg')) # 为label设置图片
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindowllllll"))
